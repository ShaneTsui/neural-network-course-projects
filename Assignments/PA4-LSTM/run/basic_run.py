...
from data.music_dataloader import MusicDataset
...
def main():
    ...
    train_loader = tdata.Dataloader(train, batch_size=config['batch_size'])
    val_loader = tdata.Dataloader(val, batch_size=config['batch_size'])
    test_loader = tdata.Dataloader(test, batch_size=config['batch_size'])
